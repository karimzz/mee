  ...
  return (
    ...
    <div style={{ position: 'relative' }}>
      ...
      <Link to={'/product/add'} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center',textDecoration:"none" }}>
        <Button style={{ width: "200px", color: "white", background: "black",textAlign:"center",border:"1px solid black"}} className='my-3'> Add New Product</Button>
      </Link>
          ...
          <Col key={product.id}>
            <Card style={{ width: '20rem' }}>
              <Card.Body>
                ...
                <h4>{product.price}$</h4>
                <Link to={'/product/edit'}><Button style={{ color: "white", background: "black", margin: "2px",width:"75px",border:"1px solid black" }} className='btn-primary' >Edit</Button></Link>
